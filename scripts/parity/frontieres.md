...
| G-STATUS | statut nu (« j'ai déjà mangé », « c'est envoyé ») ⇒ rien | `g-status-sent-fr`, `g-status-eaten-en` ; miroir `g-status-sent-named-fr` | Les deux côtés sont écrits depuis le 2026-08-26. Ce qui les sépare est le NOM, pas l'heure : « Le devis pour Acme est parti ce matin » nomme une organisation et devient une occurrence datée, « J'ai acheté du pain ce matin » porte la même ancre temporelle et ne laisse rien. ⚠ La porte ne produit pas encore le miroir, et le cas NU reste indécis : Alexis le voulait en épisode puis a dit lui-même « sans détail c'est moins évident ». |
